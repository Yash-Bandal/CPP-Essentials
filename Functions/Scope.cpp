/*
Local value remains same even if everytime ..multiple time local var function called
static local retains previoes updated value and updates it witn next call..instead of restart 
*/
// Section 11
// Scope example
#include <iostream>
...
void local_example();
void global_example(); //note..global does not mean constant..it can change with change in program
